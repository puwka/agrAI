...
const MODEL_LOCK_ITEMS: Array<{ id: string; title: string }> = [
  ...
  { id: "photo:gpt-image-2", title: "Фото → GPT Image 2" },
  { id: "photo:flux-2-pro", title: "Фото → Flux 2 Pro" },
  { id: "photo:recraft-v3", title: "Фото → Recraft V3" },
  { id: "photo:ideogram-v3", title: "Фото → Ideogram V3" },
  { id: "photo:qwen-image-2", title: "Фото → Qwen Image 2" },
  { id: "photo:seedream-v5-lite", title: "Фото → Seedream v5 lite" },

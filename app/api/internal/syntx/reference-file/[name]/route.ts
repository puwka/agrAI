...
import { requireAutomationWorker } from "../../../../../../lib/automation-worker";
...
/**
 * Syntx worker downloads reference images with AUTOMATION_WORKER_TOKEN.
 * Public /api/generations/reference-file/* requires a user session, so automation uses this route.
 */
